  ...
  <div class="body">
    <div class="dingdan">
      ...
      <div class="header_top">
        ...
        <p class="header" style="border-bottom: 2px solid #2b883a;color:#2b883a" @click="fukuan">待付款</p>
      ...
      <div style="margin-bottom: 49px;">
        <div v-for="(item,index) in NotList" :key="index" class="content">
          <div class="content_top">
            ...
            <p style="color:#2b883a" v-if="item.status===1">待付款</p>
          ...
          <div class="content_bottom" v-for="(item1,index) in NotiList" :key="index">
            ...
            <div style="width: 70%;" class="right">
              ...
              <div class="btn">
                ...
                <p @click="fukuang(item,index)" style="color:#2b883a;border:1px solid #2b883a;">去付款</p>
                <!-- <router-link
              tag="p"
              :to="{path:'/order/payment',query:{pay_type:item.pay_type,order_id:item.order_id}}"
        ...
        .then(res => {
          ...
          if (res.data.status === 200) {
            ...
            for (var i = 0; i < that.NotList.length; i++) {
              ...
              console.log(that.NotiList, "asdasd");
            }
          } else {
            that.$toast(res.msg);
          }
