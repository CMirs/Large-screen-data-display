...
<div class="body">
  <div class="dingdan">
    ...
    <div class="header_top">
      ...
      <p class="header" style="border-bottom: 2px solid #2b883a;color:#2b883a" @click="fahuo">待发货</p>
    ...
    <div v-for="(item,index) in NotList" :key="index" class="content">
      <div class="content_top">
        ...
        <p style="color:#6eb92b" v-if="item.status===2">待发货</p>
      ...
      <div class="content_bottom" v-for="(item1,index) in NotiList" :key="index">
        ...
        <div style="width: 70%;" class="right">
          ...
          <h2>共 {{item.goods_num}}件商品 合计：￥<i style="color:#2b883a;">{{item.order_amount}}</i></h2>
            <div class="btn" @click="xiangxi(item,index)">
              <p  >查看详情</p>
            </div>
        </div>
      </div>
...
.btn p {
  padding: 8px 18px;
      /* color: rgb(123, 175, 226);
    border: 2px solid rgb(123, 175, 226); */
    color:#2b883a;
