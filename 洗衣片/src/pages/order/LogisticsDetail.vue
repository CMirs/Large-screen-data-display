            ...
            <div class="box pt">
                <div class="order-info" v-for="(item,key) in logistics.goods_res" :key="key">
                    ...
                    <div class="right-detail">
                        <p><b>物流状态：</b>
                            <span v-if="wuliu.status==null" class="txt-success">已签收</span>
                          
                             <span v-else-if="wuliu.status==0" class="txt-success">已发货</span>
...
export default {
    ...
    data() {
        return {
            ...
            list:[],
            nodatas:{
                'imgSrc':'/static/images/order/wu.png',
                'text':'暂无物流信息~',
                'link':'',
                'showBtn':false
            },
        ...
        logisticsList(){
            ...
            .then((res)=>{
                ...
                if(list.status == 200){
                    ...
                    console.log(_that.wuliu,"wuliu")
                  
                  
                    if(!_that.wuliu){ 
                        console.log(!_that.wuliu,"ceshi") 
                        console.log(_that.isShow,"show")       //显示没有数据提示
                        _that.isShow=true 
                        console.log(_that.isShow,"show") 
                         console.log("666")
