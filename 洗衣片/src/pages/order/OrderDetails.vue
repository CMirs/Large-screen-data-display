    ...
    <div class="content">
      ...
      <div class="goods-list">
        <div class="single-item" v-for="(item,index) in orderDetails.goods_res" :key="index">
          <router-link :to="{path:'/cart/cartDetail',query:{id:item.goods_id}}">
            <div class="img-wrap">
              <img :src="item.img" />
            </div>
            <div class="main">
              ...
              <p>
                <span class="price">{{orderDetails.order_amount | formatMoney}}</span>
      ...
      <div class="group-wrap">
        ...
        <div class="group-line">  
          ...
          <div class="fr">￥-{{orderDetails.coupon_price }}元</div>
        </div>
        <div class="group-line">
          <div class="fl">运费</div>
