<template>
    <div>
        <div id="home">
       <!-- 头部组件 -->
		<Data-Header custom-title="修改密码" custom-fixed>
			<!-- 返回按钮 -->
        ...
        <div class="login_details">
            ...
            <input class="password_dict" type="password" v-model="password_dict" placeholder="再次输入登录密码">
            <div class="concent">
            <input class="Verification" type="text" placeholder="输入验证码" v-model="verifyCode" autocomplete="off">
            <button class="verifyCode global-option-style" style="color:#0054ff" :disabled="disabled" @click="getVerifyCode()">{{verifyText}}</button>
            </div>
            </div> 
